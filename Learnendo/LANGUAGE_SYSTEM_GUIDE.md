...
✅ **Global UI Language State** — Single source of truth for uiLanguage  
...
✅ **Header Display** — Blue badge showing current uiLanguage (EN, PT, ES, EL, HE)  
...
✅ **Multiple UI Languages** — Supports en, pt, es, el, he  
