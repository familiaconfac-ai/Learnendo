...
const L2_TRACKS = [
  // Island 1 – Short vs Long Vowels (limited to 2 key exercises + other types)
  ...createItems(2, 1, [
  ...
  ...createItems(2, 5, [
    ...
    { type: 'multiple-choice', instruction:'She sees ___ sun', options:['a','an'], correctValue:'a', audioValue:"She sees a sun." },
...
export const LESSON_CONFIGS = [
  { id: 1, title: "The Alphabet and Numbers", modules: ["L1_I1", "L1_I2", "L1_I3", "L1_I4", "L1_I5", "L1_I6", "L1_I7"] },
  { id: 2, title: "The Five Vowels", modules: ["L2_I1", "L2_I2", "L2_I3", "L2_I4", "L2_I5", "L2_I6", "L2_I7"] },
  { id: 3, title: "Daily Routines and Activities", modules: ["L3_I1", "L3_I2", "L3_I3", "L3_I4", "L3_I5", "L3_I6", "L3_I7", "L3_I8"] },
