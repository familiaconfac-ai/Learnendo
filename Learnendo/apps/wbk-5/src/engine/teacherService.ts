...
function formatProgressLabel(summary: DashboardSummary, dashboardStatus: TeacherStudentRow['dashboardStatus']): string {
...
function formatLessonsLabel(student: RankedStudent & DashboardSummary, lessonsCompleted: number): string {
...
function buildTeacherRow(student: RankedStudent & DashboardSummary, raw?: DashboardSource): TeacherStudentRow {
  ...
  return {
    ...
    lessonsCompleted,
    lessonsLabel: formatLessonsLabel(student, lessonsCompleted),
