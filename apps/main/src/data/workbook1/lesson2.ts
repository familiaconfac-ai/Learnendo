...
export const lesson2: Lesson = {
  id: "wb1_l2",
  title: "Lesson 2: Vowels and Early Reader",
  days: [
    {
      id: "wb1_l2_d1",
      type: "practice",
    ...
    },
    {
      ...
      type: "practice",
      exercises: [
        { id: 'wb1_l2_d2_e1', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "cat"?', audioValue: 'cat', options: ['A','E','I','O','U'], correctValue: 'A', isNewVocab: true },
        { id: 'wb1_l2_d2_e2', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'A', options: ['A','E','I','O','U'], correctValue: 'A' },
        { id: 'wb1_l2_d2_e3', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "bed"?', audioValue: 'bed', options: ['A','E','I','O','U'], correctValue: 'E' },
        { id: 'wb1_l2_d2_e4', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'E', options: ['A','E','I','O','U'], correctValue: 'E' },
        { id: 'wb1_l2_d2_e5', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "bike"?', audioValue: 'bike', options: ['A','E','I','O','U'], correctValue: 'I' },
        { id: 'wb1_l2_d2_e6', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'I', options: ['A','E','I','O','U'], correctValue: 'I' },
        { id: 'wb1_l2_d2_e7', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "note"?', audioValue: 'note', options: ['A','E','I','O','U'], correctValue: 'O' },
        { id: 'wb1_l2_d2_e8', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'O', options: ['A','E','I','O','U'], correctValue: 'O' },
        { id: 'wb1_l2_d2_e9', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "sun"?', audioValue: 'sun', options: ['A','E','I','O','U'], correctValue: 'U' },
        { id: 'wb1_l2_d2_e10', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'U', options: ['A','E','I','O','U'], correctValue: 'U' },
        { id: 'wb1_l2_d2_e11', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "apple"?', audioValue: 'apple', options: ['A','E','I','O','U'], correctValue: 'A' },
        { id: 'wb1_l2_d2_e12', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'A', options: ['A','E','I','O','U'], correctValue: 'A' },
        { id: 'wb1_l2_d2_e13', type: 'multiple-choice', instruction: 'Teacher: What vowel letter is in "tree"?', audioValue: 'tree', options: ['A','E','I','O','U'], correctValue: 'E' },
        { id: 'wb1_l2_d2_e14', type: 'multiple-choice', instruction: 'Teacher: What is the letter name?', audioValue: 'E', options: ['A','E','I','O','U'], correctValue: 'E' }
      ]
    },
    {
      id: "wb1_l2_d3",
      type: "practice",
      exercises: [
        { id: 'wb1_l2_d3_e1', type: 'multiple-choice', instruction: 'What is this?', displayValue: 'fa-sun', audioValue: 'sun', options: ['sun','moon','star','cloud'], correctValue: 'sun', isNewVocab: true },
        { id: 'wb1_l2_d3_e2', type: 'multiple-choice', instruction: 'What is this?', displayValue: 'fa-foot', audioValue: 'toes', options: ['toes','fingers','nose','eyes'], correctValue: 'toes' },
        { id: 'wb1_l2_d3_e3', type: 'multiple-choice', instruction: 'What is this?', displayValue: 'fa-mountain', audioValue: 'rock', options: ['rock','stone','sand','water'], correctValue: 'rock' },
        { id: 'wb1_l2_d3_e4', type: 'multiple-choice', instruction: 'What is this?', displayValue: 'fa-tree', audioValue: 'tree', options: ['tree','bush','flower','grass'], correctValue: 'tree' },
        { id: 'wb1_l2_d3_e5', type: 'multiple-choice', instruction: 'What is this?', displayValue: 'fa-apple-whole', audioValue: 'apple', options: ['apple','orange','banana','grape'], correctValue: 'apple' },
    ...
    },
    {
      ...
      type: "practice",
      exercises: [
        { id: 'wb1_l2_d5_e1', type: 'multiple-choice', instruction:'It is ___ apple', options:['a','an'], correctValue:'an', audioValue:"It's an apple.", isNewVocab:true },
        { id: 'wb1_l2_d5_e2', type: 'multiple-choice', instruction:'It is ___ kite', options:['a','an'], correctValue:'a', audioValue:"It's a kite." },
        { id: 'wb1_l2_d5_e3', type: 'multiple-choice', instruction:'He has ___ orange', options:['a','an'], correctValue:'an', audioValue:"He has an orange." },
        { id: 'wb1_l2_d5_e4', type: 'multiple-choice', instruction:'She sees ___ sun', options:['a','an'], correctValue:'a', audioValue:"She sees a sun." },
        { id: 'wb1_l2_d5_e5', type: 'multiple-choice', instruction:'We read ___ book', options:['a','an'], correctValue:'a', audioValue:"We read a book." },
        { id: 'wb1_l2_d5_e6', type: 'multiple-choice', instruction:'I eat ___ apple', options:['a','an'], correctValue:'an', audioValue:"I eat an apple." },
        { id: 'wb1_l2_d5_e7', type: 'multiple-choice', instruction:'They fly ___ kite', options:['a','an'], correctValue:'a', audioValue:"They fly a kite." },
        { id: 'wb1_l2_d5_e8', type: 'multiple-choice', instruction:'He found ___ rock', options:['a','an'], correctValue:'a', audioValue:"He found a rock." },
        { id: 'wb1_l2_d5_e9', type: 'multiple-choice', instruction:'She wears ___ hat', options:['a','an'], correctValue:'a', audioValue:"She wears a hat." },
        { id: 'wb1_l2_d5_e10', type: 'multiple-choice', instruction:'It is ___ orange in the box', options:['a','an'], correctValue:'an', audioValue:"It's an orange in the box." }
      ]
    },
    {
      id: "wb1_l2_d6",
