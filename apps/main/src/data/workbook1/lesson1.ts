...
export const lesson1: Lesson = {
  ...
  days: [
    ...
    },
    {
      ...
      type: "practice",
      exercises: [
        { id: 'wb1_l1_d5_e1',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Orange', options: ['Orange', 'Yellow', 'Red',    'Brown'],  correctValue: 'Orange', translation: 'Orange = Laranja'  },
        { id: 'wb1_l1_d5_e2',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Black',  options: ['Black',  'White',  'Brown',  'Blue'],   correctValue: 'Black',  translation: 'Black = Preto'     },
        { id: 'wb1_l1_d5_e3',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Purple', options: ['Purple', 'Blue',   'Pink',   'Black'],  correctValue: 'Purple', translation: 'Purple = Roxo'     },
        { id: 'wb1_l1_d5_e4',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Pink',   options: ['Pink',   'Red',    'Purple', 'White'],  correctValue: 'Pink',   translation: 'Pink = Rosa'       },
        { id: 'wb1_l1_d5_e5',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'White',  options: ['White',  'Yellow', 'Black',  'Orange'], correctValue: 'White',  translation: 'White = Branco'    },
        { id: 'wb1_l1_d5_e6',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Brown',  options: ['Brown',  'Orange', 'Black',  'Red'],    correctValue: 'Brown',  translation: 'Brown = Marrom'    },
        { id: 'wb1_l1_d5_e7',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Green',  options: ['Green',  'Blue',   'Yellow', 'Brown'],  correctValue: 'Green',  translation: 'Green = Verde'     },
        { id: 'wb1_l1_d5_e8',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Yellow', options: ['Yellow', 'Orange', 'Green',  'White'],  correctValue: 'Yellow', translation: 'Yellow = Amarelo'  },
        { id: 'wb1_l1_d5_e9',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Blue',   options: ['Blue',   'Purple', 'Green',  'Black'],  correctValue: 'Blue',   translation: 'Blue = Azul'       },
        { id: 'wb1_l1_d5_e10', type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Red',    options: ['Red',    'Pink',   'Orange', 'Brown'],  correctValue: 'Red',    translation: 'Red = Vermelho'    },
      ]
    },
    {
      id: "wb1_l1_d6",
      ...
      exercises: [
        ...
        { id: 'wb1_l1_d6_e7',  type: 'multiple-choice', instruction: 'The teacher says: "Nice to meet you." — Choose the correct response.', audioValue: 'Nice to meet you.', options: ['Nice to meet you.', 'Good morning!', 'My name is Lucas.', 'Goodbye!'], correctValue: 'Nice to meet you.', isNewVocab: true, translation: 'Prazer em conhecê-lo = Nice to meet you' },
        ...
        { id: 'wb1_l1_d6_e10', type: 'multiple-choice', instruction: 'The teacher says: "Goodbye!" — Choose the correct response.', audioValue: 'Goodbye!', options: ['Hello!', 'Goodbye!', 'Good morning!', "I'm fine, thank you."], correctValue: 'Goodbye!', isNewVocab: true, translation: 'Goodbye = Tchau / Até logo' },
      ]
    },
    {
      id: "wb1_l1_d7",
      ...
      exercises: [
        ...
        { id: 'wb1_l1_d7_e17', type: 'identification', instruction: 'Listen and pick the correct number.', audioValue: 'Forty',      options: ['4',  '14', '40', '44'],  correctValue: '40',  translation: '40 = Quarenta' },
        { id: 'wb1_l1_d7_e22', type: 'identification', instruction: 'Listen and pick the correct number.', audioValue: 'One hundred', options: ['10', '100', '1000', '110'], correctValue: '100', translation: '100 = Cem' },
        // --- Colors (5) — visual squares, no labels ---
        { id: 'wb1_l1_d7_e3',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Red',    options: ['Red',    'Orange', 'Brown',  'Pink'],   correctValue: 'Red',    translation: 'Red = Vermelho'   },
        { id: 'wb1_l1_d7_e8',  type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Blue',   options: ['Blue',   'Purple', 'Green',  'Black'],  correctValue: 'Blue',   translation: 'Blue = Azul'      },
        { id: 'wb1_l1_d7_e13', type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Yellow', options: ['Yellow', 'Orange', 'White',  'Green'],  correctValue: 'Yellow', translation: 'Yellow = Amarelo' },
        { id: 'wb1_l1_d7_e18', type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Purple', options: ['Purple', 'Blue',   'Pink',   'Black'],  correctValue: 'Purple', translation: 'Purple = Roxo'    },
        { id: 'wb1_l1_d7_e23', type: 'identification', instruction: 'Listen and tap the correct color.', audioValue: 'Brown',  options: ['Brown',  'Orange', 'Red',    'Black'],  correctValue: 'Brown',  translation: 'Brown = Marrom'   },
        ...
        { id: 'wb1_l1_d7_e19', type: 'multiple-choice', instruction: 'The teacher says: "Nice to meet you." — Choose the correct response.', audioValue: 'Nice to meet you.', options: ['Nice to meet you.', 'Good night!', 'Goodbye!', 'Good morning!'], correctValue: 'Nice to meet you.', translation: 'Prazer em conhecê-lo = Nice to meet you' },
