...
const dialogue17 = "Guide: Where is Lucas? Anna: He's near the lion. Guide: Is he afraid? Anna: No, he isn't. Guide: Is he happy? Anna: Yes, he is. Lucas: I'm happy today!";
const dialogue18 = "Guide: Are Ben and Anna late? Lucas: No, they ain't. Guide: Are they near the giraffes? Lucas: Yes, they are. Guide: Are they ready to see more animals? Lucas: Yes, they are. Guide: Good. They ain't late, and they're ready.";
...
export const lesson8 = buildLesson(8, 'Lesson 8: Spoken Patterns', [
  ...
  { exercises: [
    ...
    write('', 'Yes, they are.', 'Answer the question: Are Anna and Ben ready?', ['Yes, Anna and Ben are.'], { instruction: 'Write a complete short answer.', finalTestSelectionAudio: 'Are Anna and Ben ready? Yes, they are.' }),
    ...
    write('', 'Yes, she is.', 'Answer the question: Is Emily near the giraffes?', [], { instruction: 'Write a complete short answer.', finalTestSelectionAudio: 'Is Emily near the giraffes? Yes, she is.' }),
  ...
  { exercises: [
    speak('Today is Tuesday. The students are ready to explore the zoo.', [], { instruction: 'Read the context, then listen and repeat the short model.', displayValue: `Reading — At the Zoo\n${zooReading}`, assessmentMode: 'shadowing', coverageObjective: 'Natural spoken contractions', finalTestSelectionAudio: zooReading, finalTestSelectionAnswer: zooReading }),
    speak("Lucas is near the lion. He isn't afraid.", [], { instruction: 'Listen and repeat exactly what you hear.', displayValue: "Lucas is near the lion. He isn't afraid.", assessmentMode: 'shadowing', coverageObjective: 'Natural spoken contractions', finalTestSelectionAudio: dialogue17, finalTestSelectionAnswer: dialogue17 }),
  ...
  { exercises: [
    ...
    speak("Ben and Anna ain't late. They're ready.", [], { instruction: 'Informal English — listen and repeat exactly what you hear.', displayValue: "Dialogue 18 — They Ain't Late\nInformal Spoken English\n\nBen and Anna ain't late. They're ready.", assessmentMode: 'shadowing', finalTestSelectionAudio: dialogue18, finalTestSelectionAnswer: dialogue18, ...informal("Ben and Anna aren't late. They're ready.") }),
