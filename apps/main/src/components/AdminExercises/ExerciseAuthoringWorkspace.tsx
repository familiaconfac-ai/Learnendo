...
import {
  getDaySequenceState, publishDaySequence, saveDaySequenceDraft,
...
export const ExerciseAuthoringWorkspace: React.FC<{
  ...
  const publish = async () => {
    ...
    const destructive = operation === 'reconstruct' || operation === 'replace_day' || operation === 'replace_positions';
