...
const ExerciseForm: React.FC<{ value: CanonicalExerciseInput; onChange: (value: CanonicalExerciseInput) => void; lockType?: boolean }> = ({ value, onChange }) => {
  ...
  return <div className="space-y-3">
    ...
    {(oral || value.type === 'writing' || value.type === 'listening') && <TextList label="Respostas aceitas" values={value.acceptedAnswers ?? []} onChange={(acceptedAnswers) => patch({ acceptedAnswers })} />}
