...
assert.match(service, /if \(!isVisibleExerciseReport\(report\)\) return false/, 'resolved reports must leave the operational dashboard list');
...
assert.match(dashboard, /Todos os status da lista/, 'the status filter must describe the operational list');
