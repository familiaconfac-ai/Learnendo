...
const outfile = resolve(root, 'node_modules/.cache/exercise-editor-publication.integration.mjs');
await build({
  absWorkingDir: root, entryPoints: ['scripts/exercise-editor-publication.integration.ts'],
