...
if (!['language-phase1.integration.ts', 'grammar-focus-upgrade.integration.tsx', 'language-phase2.integration.tsx', 'board-control.integration.ts'].includes(entry)) throw new Error('Unknown integration entry.');
