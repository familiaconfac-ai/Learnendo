...
export const PLACEMENT_TEST_QUESTIONS: PlacementQuestion[] = [
  ...
  },
  {
    ...
    options: ['2 AM', '3 AM', '2 PM', '3 PM'],
    correctAnswerIndex: 1,
    explanation: 'The sentence states "three o\'clock" which could be 3 AM or 3 PM, most commonly understood as 3 o\'clock afternoon time.'
  },
  {
    id: 'p1_listen_04',
    part: 1,
  ...
  // Listening
  {
    ...
    options: ['Where is the train?', 'Can you help with directions?', 'What time is it?', 'How are you?'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['Swimming and dancing', 'Playing football and reading', 'Writing and cooking', 'Drawing and singing'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['Free', 'Expensive', 'Rich', 'Poor'],
    correctAnswerIndex: 1,
  ...
  // Reading
  {
    ...
    options: ['Cold and rainy', 'Warm and sunny', 'Cold and cloudy', 'Hot and humid'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['The movie was boring', 'The movie was excellent', 'The movie was too long', 'The movie was confusing'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['Reading books daily', 'Practicing speaking daily', 'Watching movies', 'Listening to music'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['Clear', 'Uncertain in meaning', 'Direct', 'Simple'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['Confuse', 'Clarify', 'Ignore', 'Criticize'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['Ignorance of', 'Concealment of', 'Awareness of', 'Documentation of'],
    correctAnswerIndex: 1,
    explanation: '"Concealment of" (hiding) would damage reputation; others wouldn\'t necessarily.'
  },
  {
    id: 'p4_grammar_40',
    part: 4,
